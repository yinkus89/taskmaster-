...
import TaskListPage from './component/TaskListPage';  // TaskListPage component to show a list of tasks
        ...
        <>
            ...
            <div className="container">
                <Routes>
                    ...
                    <Route path="/tasks/:taskId" element={<TaskPage />} />  {/* Route for individual task details */}
                    <Route path="/about" element={<AboutUsPage />} />  {/* About Us route */}
                    <Route path="/tasks/list" element={<TaskListPage />} />  {/* Task List route */}
                </Routes>
            </div>
            <Footer />
        </>
